    ...
    <tr className="hover:bg-gray-100 group transition">
      ...
      <td className="px-4 sm:px-6 py-4">
        <span
          className={`px-3 py-1 rounded-full text-xs font-bold ${
            roleColors[bgColor] || "bg-gray-100 text-gray-600"
          }`}
        >
          {role}
        </span>
      ...
      <td className="px-4 sm:px-6 py-4 text-right">
        <div className="flex justify-end gap-2 opacity-100 group-hover:opacity-100 transition">
          <button className="p-2 rounded-full hover:bg-purple-100 hover:text-purple-600 transition">
            <MdEdit />
          </button>
          <button className="p-2 rounded-full hover:bg-red-100 hover:text-red-500 transition">
            <MdDelete />
          </button>
        </div>
      </td>
