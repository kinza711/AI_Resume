  ...
  return (
    <section className="bg-white/70 backdrop-blur-[20px] rounded-lg p-8 shadow-sm overflow-hidden relative">
      ...
      <div className="relative">
        <textarea
          className="w-full bg-[#e6e8ea] border-none rounded-xl px-6 py-4 focus:ring-2 focus:ring-[#5f00e3] focus:bg-white transition-all font-medium text-[#191c1e] leading-relaxed"
          rows="6"
          placeholder="Tell us about your career journey..."
          defaultValue="Senior Architect with over 10 years of experience in designing high-performance cloud infrastructures and microservices ecosystems. Proven track record of leading cross-functional teams to deliver scalable solutions for Fortune 500 companies. Passionate about AI integration and sustainable engineering practices."
        />
